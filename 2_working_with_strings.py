...
print("First character of mayor's name:", chicago_mayor[0]) 
print("Last character of mayor's name:", chicago_mayor[-1]) 

# print the first letter of the mayor

print("First four letters of mayor's name:", chicago_mayor[0:4]) 

# first number in slicing is inclusive,
# second is exclusive
# son

print("Last 3 letters of mayor's name:", chicago_mayor[-3:])

last_name  = "Zuniga"

print("Last 3 characters of mayor's name:", last_name[-3:]) 
...
poppins = "supercalifragilisticexpialdocious"

print("First character of poppins:", poppins[-7:]) 
print("Uppercase the string poppins:", poppins.upper())
print("First 5 letters of poppins", poppins[0:5])

# declaration of independence lenght
...
print("lenght of the first paragraph of the decalaration of independence: ", len(declaration_of_independence))
